...
%prep
%setup -q -n dnf-4.21.0
cd %{_builddir}/dnf-4.21.0
%patch -P 1 -p1
%patch -P 2 -p1
%patch -P 3 -p1
%patch -P 4 -p1
...
%files man
%defattr(0644,root,root,0755)
/usr/share/man/man5/dnf4-transaction-json.5
/usr/share/man/man5/dnf4.conf.5
/usr/share/man/man7/dnf4.modularity.7
/usr/share/man/man8/dnf-automatic.8
/usr/share/man/man8/dnf4.8
